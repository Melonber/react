Три файла: App.js-является навигатором, Login-форма логина и регистарции, при вводе валидных данных, прописанных в условии if используя AsyncStorage перенаправляет
